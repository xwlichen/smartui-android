...
public class SMUIImageView extends AppCompatImageView {
    ...
    public SMUIImageView(Context context) {
        this(context, null, R.attr.SMUIImageViewStyle);
    }

    public SMUIImageView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.SMUIImageViewStyle);
    }
    ...
    public SMUIImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(
                attrs, R.styleable.SMUIImageView, defStyleAttr, 0);

        mBorderWidth = array.getDimensionPixelSize(R.styleable.SMUIImageView_smui_border_width, 0);
        mBorderColor = array.getColor(R.styleable.SMUIImageView_smui_border_color, DEFAULT_BORDER_COLOR);
        mSelectedBorderWidth = array.getDimensionPixelSize(
                R.styleable.SMUIImageView_smui_selected_border_width, mBorderWidth);
        mSelectedBorderColor = array.getColor(
                R.styleable.SMUIImageView_smui_selected_border_color, mBorderColor);
        mSelectedMaskColor = array.getColor(
                R.styleable.SMUIImageView_smui_selected_mask_color, Color.TRANSPARENT);
        ...
        mIsTouchSelectModeEnabled = array.getBoolean(
                R.styleable.SMUIImageView_smui_is_touch_select_mode_enabled, true);
        mIsCircle = array.getBoolean(R.styleable.SMUIImageView_smui_is_circle, false);
        if (!mIsCircle) {
            mIsOval = array.getBoolean(R.styleable.SMUIImageView_smui_is_oval, false);
        }
        if (!mIsOval) {
            mCornerRadius = array.getDimensionPixelSize(
                    R.styleable.SMUIImageView_smui_corner_radius, 0);
        }
        array.recycle();
    }
