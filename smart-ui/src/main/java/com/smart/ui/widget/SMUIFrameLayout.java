...
public class SMUIFrameLayout extends FrameLayout implements ISMUILayout {
    private SMUILayoutHelper mLayoutHelper;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new SMUILayoutHelper(context, attrs, defStyleAttr, this);
    }
    ...
    @Override
    public void setRadiusAndShadow(int radius, @SMUILayoutHelper.HideRadiusSide int hideRadiusSide, int shadowElevation, final float shadowAlpha) {
    ...
    @Override
    public void setRadius(int radius, @SMUILayoutHelper.HideRadiusSide int hideRadiusSide) {
