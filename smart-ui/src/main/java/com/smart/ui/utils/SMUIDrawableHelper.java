 ...
 * @description :
 */
public class SMUIDrawableHelper {
    private static final String TAG = SMUIDrawableHelper.class.getSimpleName();
    ...
    public static Bitmap createBitmapFromView(View view, int leftCrop, int topCrop, int rightCrop, int bottomCrop) {
        Bitmap originBitmap = SMUIDrawableHelper.createBitmapFromView(view);
