 ...
 * @description :
 */
public class SMUIStatusBarHelper {
    ...
    public static float virtualDensity = -1;
    public static float virtualDensityDpi = -1;
    private static int statusbarHeight = -1;
    private static @StatusBarType int statuBarType = STATUSBAR_TYPE_DEFAULT;
    private static Integer transparentValue;
    ...
    private static boolean supportTranslucent() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
                ...
                && !(SMUIDeviceHelper.isEssentialPhone() && Build.VERSION.SDK_INT < 26);
    }
    ...
    public static void translucent(Window window, @ColorInt int colorOn5x) {
        ...
        if (SMUIDeviceHelper.isMeizu() || (SMUIDeviceHelper.isMIUI() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M)) {
...
//            }
    ...
    public static boolean setStatusBarLightMode(Activity activity) {
        ...
        if (SMUIDeviceHelper.isZTKC2016()) {
            return false;
        }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        if (SMUIDeviceHelper.isMIUIV9() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return true;
        }
        return SMUIDeviceHelper.isMIUIV5() || SMUIDeviceHelper.isMIUIV6() ||
                SMUIDeviceHelper.isMIUIV7() || SMUIDeviceHelper.isMIUIV8();
    }
        ...
        if (fieldName != null) {
            try {
                ...
                if (field != null) {
                    ...
                    if (type == int.class) {
                        transparentValue = field.getInt(null);
                    }
                }
            } catch (Exception ignored) {
            }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(SMUIDeviceHelper.isZUKZ1() || SMUIDeviceHelper.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (SMUIDeviceHelper.isTablet(context)
                && statusbarHeight > SMUIDisplayHelper.dp2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
            ...
            if (statusbarHeight <= 0) {
                if (virtualDensity == -1) {
                    ...
                    statusbarHeight = (int) (STATUS_BAR_DEFAULT_HEIGHT_DP * virtualDensity + 0.5f);
                }
            }
        }
    }
