 ...
 * @description : 手机型号helper
 */
public class SMUIDeviceHelper {

    private final static String TAG = "SMUIDeviceHelper";
    ...
    private static boolean isTabletChecked = false;
    private static boolean isTabletValue = false;
    ...
    static {
        ...
        try {
            ...
            // miui
            miuiVersionName = getLowerCaseName(properties, getMethod, KEY_MIUI_VERSION_NAME);
            //flyme
    ...
    public static boolean isTablet(Context context) {
        ...
        isTabletValue = _isTablet(context);
    ...
    public static boolean isFlyme() {
        return !TextUtils.isEmpty(flymeVersionName) && flymeVersionName.contains(FLYME);
    }
    ...
    public static boolean isMIUIV5() {
        return "v5".equals(miuiVersionName);
    }

    public static boolean isMIUIV6() {
        return "v6".equals(miuiVersionName);
    }

    public static boolean isMIUIV7() {
        return "v7".equals(miuiVersionName);
    }

    public static boolean isMIUIV8() {
        return "v8".equals(miuiVersionName);
    }

    public static boolean isMIUIV9() {
        return "v9".equals(miuiVersionName);
    }

    public static boolean isFlymeVersionHigher5_2_4() {
        //查不到默认高于5.2.4
        boolean isHigher = true;
        if (flymeVersionName != null && !flymeVersionName.equals("")) {
            Matcher matcher = pattern.matcher(flymeVersionName);
            if (matcher.find()) {
