 ...
 * @description :
 */
public class SmartShareElementHelper {
    ...
    public static Bundle buildOptionsBundle(@NonNull final Activity activity, @Nullable final IShareElements getShareElement) {
        if (!SmartTransitionHelper.ENABLE) {
            return new Bundle();
        }
        ...
        return SmartTransitionHelper.getTransitionBundle(activity, viewArray);
    }
        ...
        if (!sInited) {
            ...
            application.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
                ...
                public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
                    SmartTransitionHelper.enableTransition(activity);
                }
